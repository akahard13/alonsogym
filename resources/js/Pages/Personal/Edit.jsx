...
const Edit = ({ generos, personal }) => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        put(route('personal.update', personal.id)); // Asegúrate de tener la ruta correcta para actualizar
    };
    ...
    return (
        ...
        >
            ...
            <h1 className="text-2xl font-bold mb-6 text-center">Editar miembro del personal</h1>
