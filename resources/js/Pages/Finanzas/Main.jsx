...
const Main = ({ datos, auth, editar, eliminar, create }) => {
    const rol = auth.user.rol;
    const [searchTerm, setSearchTerm] = useState(''); // Estado para el término de búsqueda
    const filteredDatos = datos.filter((dato) => {
        const descripcion = dato.descripcion || ''; // Asegurarse de que descripción siempre exista
        const categoria = dato.categoria.nombre || ''; // Asegurarse de que categoría siempre exista
        return (
